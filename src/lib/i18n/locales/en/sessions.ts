export default {
  ...
  notifySelfTest: 'Notification self-test',
  notifySelfTestHint: 'Send a test notification to confirm Windows actually shows them',
  notifySelfTestRun: 'Test',
  notifySelfTestSent: 'Notification sent',
  notifyBlockedByOs: 'Windows has notifications turned off for this app — enable them in system settings',
