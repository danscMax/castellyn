export default {
  ...
  servicesHeading: '服务',
  servicesSub: '本地 LLM 服务 — 网关、分叉后端和付费 GLM 路由。在此启动/停止它们并绑定到配置。',
  managed: '托管',
  managedTip: '受管理的栈服务 — 由 Castellyn 启动/停止（来自 stack.json）。',
  moreActions: '更多操作',
  stackStartAll: '全部启动',
  ...
  rcOpencodeKeyPlaceholder: '留空 → 保留当前或 {env:FREELLMAPI_API_KEY}',
  rcOpencodeKeyTip: '若填写则以字面量写入 opencode.json。留空：保留当前密钥，否则写入 {env:FREELLMAPI_API_KEY} 占位符。',
  rcOpencodeBtn: '连接',
