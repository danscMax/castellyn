...
export default {
  ...
  home_drift_label_marketplace: 'Marketplace versions',
  ...
  home_gc_empty: 'No garbage',
  home_gc_summary: 'Garbage: {size} across {n} items',
  home_gc_wrongos: '{size} more — wrong-OS binaries (not deletable from the GUI)',
  home_gc_show_btn: 'Show & clean up…',
  home_gc_modal_selected: 'Selected: {size}',
  home_gc_modal_delete_btn: 'Delete selected (to Recycle Bin)',
  home_gc_confirm_title: 'Move garbage to the Recycle Bin?',
  home_gc_confirm_msg: 'The selected items will be moved to the Windows Recycle Bin — this is reversible.',
  home_gc_confirm_btn: 'Move to Recycle Bin',
  home_gc_deleted_toast: 'Deleted {n}, freed {size}',
  home_gc_skipped_toast: 'Items skipped: {n}',
  home_gc_cat_stale: 'stale version',
  home_gc_cat_tempgit: 'temp_git',
  home_gc_cat_bak: '.bak',
  home_gc_cat_wrongos: 'wrong OS',
  ...
  plugin_bump_log: '▶ Plugin {id}: bump {level} + refresh…',
  ...
  onb_state_ok: 'done',
  onb_state_todo: 'needs action',
  onb_state_unknown: 'not determined',
