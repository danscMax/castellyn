export default {
  ...
  checkAll: 'Check all',
  checkAllTip: 'Check liveness of every custom provider',
  checkAllDone: 'Checked: {ok} of {total} are up',
  ...
  statusPassword: 'password set',
  statusToken: 'token set',
  statusNone: 'not set',
  deleteAuthTip: 'Remove this stored credential from Credential Manager',
  deleteEmail: 'Delete stored email',
  deletePassword: 'Delete stored password',
  deleteToken: 'Delete stored token',
  authDeleted: 'freellmapi {key} removed from Credential Manager.',
