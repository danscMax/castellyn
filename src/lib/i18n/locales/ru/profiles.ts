export default {
  ...
  noSharedFiles: 'Профили без общих файлов (CLAUDE.md, RTK.md, разрешения): {names}. Это может быть намеренно — ничего не добавляется само.',
  addSharedFiles: 'Добавить в {name}',
  addSharedFilesTip: 'Подключить профилю «{name}» общие файлы: CLAUDE.md и RTK.md импортом, разрешения копией. Существующее не трогается.',
  driftedFiles: 'Копии общих файлов разошлись с оригиналом: {names}. Возможно, так и задумано — само ничего не перезаписывается.',
  syncSharedFiles: 'Обновить {name}',
  syncSharedFilesTip: 'Перезаписать разошедшиеся копии профиля «{name}» общим оригиналом. Правки в этих файлах будут потеряны.',
  ...
  lcCancel: 'Отмена',
  lcApply: 'Применить',
  lcSaved: 'Настройки запуска профиля «{name}» сохранены',

  // Ф2.5 — Матрица (провайдер / прокси / общие папки одной таблицей)
  matrixTitle: 'Матрица',
  matrixHint: 'Правки копятся и применяются одной кнопкой с предпросмотром',
  matrixEmpty: 'Нет профилей для отображения.',
  matrixColProxy: 'Прокси',
  matrixColFolders: 'Общие папки',
  matrixProviderOauth: 'Подписка (OAuth)',
  matrixProxyNone: 'нет',
  matrixProxyTip: 'HTTP(S)- или SOCKS5-прокси для этого профиля (пусто — без прокси)',
  matrixProxyInvalid: 'Должен начинаться с http(s):// или socks5://',
  matrixFoldersTip: 'Какие общие папки связаны у этого профиля — нажми, чтобы изменить',
  matrixFolderReal: 'реальные данные',
  matrixFolderMissing: 'нет связи',
  ...
  matrixReset: 'Отменить',
  matrixResetTip: 'Сбросить все несохранённые правки',
  matrixNoWrite: 'Ничего не пишется до подтверждения предпросмотра',
  matrixCatProvider: 'провайдер',
  matrixCatProxy: 'прокси',
  matrixCatFolders: 'папки',
  matrixCatPlugins: 'плагины',
  matrixColPlugins: 'Плагины',
  matrixColMcp: 'MCP',
  matrixPluginsTip: 'Включённые плагины этого профиля — нажми, чтобы настроить',
  matrixPluginInherited: 'унаследовано',
  matrixPluginOff: 'выкл',
  matrixMcpTip: 'Развёрнутые MCP-серверы — нажми, чтобы додеплоить или снять лишние',
  matrixMcpMissing: 'Отсутствуют',
  matrixMcpExtras: 'Лишние',
  matrixMcpDeployBtn: 'Додеплоить в профиль',
  matrixMcpRemoveTip: 'Снять лишний сервер',
  matrixMcpInSync: 'Всё в синхроне',
  matrixPreviewTitle: 'Предпросмотр применения',
  matrixPreviewConfirm: 'Подтвердить и применить',
  matrixPreviewBack: 'Назад',
  matrixPreviewNote: 'После применения — верификация фактического состояния (перечитывание матрицы)'
};
