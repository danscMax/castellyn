...
- ~~UI-трек V9/V3 лаунчера~~ ✅ сделан (лаунчер C, ead2274).
- ~~Матрица V2: колонки плагины/MCP~~ ✅ сделана (42b9d29 + фикс 2514641).
...
- Большой живой смоук владельца: GC-чистка, bump плагина, «Обновить всё» (max/speckit),
  matrix apply (провайдер/прокси/папки/плагины), MCP-додеплой/снятие extras, лаунчер C,
  ре-смоук ложного «готово» (f96fb5d).
