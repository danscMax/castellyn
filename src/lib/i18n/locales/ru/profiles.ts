export default {
  ...
  orphansTitle: 'Посторонние каталоги: {n}',
  orphansHint: 'Каталоги ~/.claude-* на диске, которых нет в списке профилей (брошенные или чужие). «Усыновить» — сделать полноценным профилем; «Удалить» — в Корзину (обратимо).',
  orphanModified: 'изменён {time}',
  orphanAdopt: 'Усыновить',
  orphanAdoptTip: 'Зарегистрировать «{name}» как профиль и связать общие папки (каталог уже есть)',
  orphanDelete: 'Удалить',
  orphanDeleteTip: 'Переместить каталог «.claude-{name}» в Корзину (обратимо)',
  orphanDeleted: 'Каталог «.claude-{name}» перемещён в Корзину',
  orphanDeleteError: 'Не удалось удалить «.claude-{name}»',
