...
export default {
  ...
  onb_state_ok: 'готово',
  onb_state_todo: 'требует действия',
  onb_state_unknown: 'не определено',
  ...
  onb_install_confirm: 'На машине уже есть профили ({n}). Переустановка перезапишет их конфигурацию. Продолжить?',
  onb_open_tab: 'Открыть вкладку',
  unblock_enable_now: 'Включить сейчас',
  onb_fix_failed: 'Шаг «{step}» завершился с ошибкой — серия остановлена',
  run_watchdog: 'Процесс молчит 5 минут — ожидание снято, проверьте консоль'
};
