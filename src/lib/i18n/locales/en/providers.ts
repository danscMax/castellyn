export default {
  ...
  start: 'Start',
  openLog: 'Open log',
  openLogTip: 'Open the log file for “{name}”',
  noLogYet: 'This service has no log file yet',
  restart: 'Restart',
  ...
  servicesSub: 'Local LLM services — the gateway, fork backends and the paid GLM router. Start/stop them and bind them to profiles here.',
  managed: 'managed',
  managedTip: 'A managed stack service — Castellyn starts/stops it (from stack.json).',
