export default {
  ...
  weekliesHeading: '每周存档（{n}）',
  revealItemTitle: '在资源管理器中显示此存档',
  verify: '校验',
  verifyItemTitle: '检查此存档是否损坏（列出其内容）',
  verifyOk: '存档正常 — {n} 个条目',
  verifyFail: '存档已损坏或无法读取',
  extract: '解压',
  extractItemTitle: '将此存档解压到你选择的文件夹（不影响实时 ~/.claude）',
  extractOk: '已解压',
  extractFail: '无法解压存档',
  importZip: '导入 zip…',
  importZipTip: '从任意路径验证并解压备份 zip（例如来自另一台机器）',
  importOk: '已导入：{n} 个文件',
  importFail: '无法导入存档',
  deleteWeeklyTitle: '删除此每周存档',
  deleteWeeklyMsg: '永久删除此每周存档（skills/agents/commands）。不影响快照和实时配置。',
  restore: '恢复',
  emptyTitle: '暂无快照',
