export default {
  ...
  monitorsSection: 'Background monitors',
  monitorsSectionDesc: 'What Castellyn polls in the background. Turning one off stops that poll.',
  limitsMonitor: 'Usage-limit monitor',
  limitsMonitorDesc: 'Polls each profile’s Anthropic limits every 5 minutes and warns at 85% and 99%.',
  stackHealthMonitor: 'Stack-health monitor',
  stackHealthMonitorDesc: 'Checks LLM-stack service liveness every 30 seconds and notifies when a service goes down.',
  updateCheckOnStart: 'Check for updates at startup',
  updateCheckOnStartDesc: 'Quietly check for a Castellyn update at launch — badge only, never auto-installs.',
  sessionsSection: 'Sessions',
  sessionsSectionDesc: 'Notification and after-limit behaviour for the Sessions tab (same settings as the Sessions popover).',
