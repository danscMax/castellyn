...
async fn run_config_drift(
    ...
    let (script_rel, args): (&str, Vec<String>) = match action.as_str() {
        ...
        "sync-now" => (crate::backups::BACKUP_SCRIPT_REL, vec!["-Force".to_string()]),
        _ => {
            return Err(trv(
...
fn app_paths() -> serde_json::Value {
    ...
    serde_json::json!({
        ...
        "backupDir": abs(crate::backups::BACKUP_DIR_REL),
    })
}
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            backups::reveal_backup,
            backups::delete_backup,
            backups::verify_backup,
            backups::extract_backup,
            backups::import_backup_zip,
            backups::run_backup,
            read_profiles,
            run_profiles,
            repair_all_profiles,
            ...
            ssh_hosts::save_ssh_host,
            ssh_hosts::delete_ssh_host,
            ssh_hosts::test_ssh_host,
            monitors::list_monitors,
            monitors::prepare_detach,
            monitors::take_detach,
            monitors::open_monitor_window,
